...
JOB_NAME = args_disponiveis['JOB_NAME'] if args_disponiveis['JOB_NAME'] else "bq-silver-inep-alfabetizacao-uf"
...
for entidade_atual in tabelas_para_processar:
    ...
    try:
        ...
        # 2. Cache temporário em memória para otimizar os testes de qualidade
        df_silver.persist()

        # 3. Execução da verificação de qualidade [INCLUÍDO]
        ...
        # Liberação obrigatória do cache para não esgotar a memória do Glue
