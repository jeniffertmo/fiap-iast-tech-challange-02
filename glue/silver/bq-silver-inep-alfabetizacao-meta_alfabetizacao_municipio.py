...
JOB_NAME = args_disponiveis['JOB_NAME'] if args_disponiveis['JOB_NAME'] else "bq-silver-inep-alfabetizacao-meta_alfabetizacao_municipio"
...
for entidade_atual in tabelas_para_processar:
    ...
    try:
        ...
        # 2. Persistir em cache temporário para otimizar os testes de qualidade subsequentes
        df_silver.persist()

        # 3. Executar Validação de Qualidade
        ...
        # 4. Gravação unificada criando pastas limpas no seu S3
        df_silver.write \
        ...
        # Liberação obrigatória do cache para manter a saúde do cluster Glue
