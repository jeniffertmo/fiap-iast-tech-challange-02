...
JOB_NAME = args_disponiveis['JOB_NAME'] if args_disponiveis['JOB_NAME'] else "bq-silver-inep-alfabetizacao-meta_alfabetizacao_brasil"
...
# ============================================================
# REGRAS DE QUALIDADE (DATA QUALITY - DQ) — [INCLUÍDO]
# ============================================================
CHECKS = {
    "alunos": [
